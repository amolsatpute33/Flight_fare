...
SCALER_URL = "https://drive.google.com/uc?export=download&id=YOUR_SCALER_FILE_ID"
COLUMN_URL = "https://drive.google.com/uc?export=download&id=YOUR_COLUMN_FILE_ID"
...
if st.button("Predict Fare"):
    ...
    st.success(f"💰 Estimated Fare: ₹ {round(price,2)}")
